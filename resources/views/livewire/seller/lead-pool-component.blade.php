    <main>
        <div class=" container table-responsive fs-md mb-4">
                <table class="table table-hover mb-0">
                        ...
                        @foreach($lead as $info)
                            <tr>
                                <td class="py-3 align-middle">{{$info->id}}</td>
                                <td class="py-3 align-middle">{{$info->name}}</td>
                                <td class="py-3 align-middle">{{$info->phone}}</td>
                                <td class="py-3 align-middle">{{$info->email}}</td>
                                <td class="py-3 align-middle">{{$info->city}}</td>
                                <td class="py-3 align-middle">{{$info->event->eventname}}</td>
