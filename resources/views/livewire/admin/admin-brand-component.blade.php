...
<div class="container">
  <div class="fw-light h5 lh-1">{{$legandary -> brand_name}}</div>
  <div class="small text-muted fw-bold">{{$legandary -> organisation}}</div>
</div>
  <div class="container">
    <h1>Contact</h1>
  ...
  <div class="container">
    ...
    @foreach($legandary as $brand)
      ...
      @php 
           $businessEvent = DB::table('events')->where('id', $brand)->get();
      @endphp
