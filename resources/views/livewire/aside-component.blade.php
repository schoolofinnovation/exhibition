    ...
    <div class="offcanvas-body py-grid-gutter px-lg-grid-gutter">
      ...
      <div class="widget widget-categories mb-4 pb-4 border-bottom">
        ...
        <div class="accordion mt-n1" id="shop-categories">
          @foreach ($expo as $category)
          <!-- Shoes-->
          <div class="accordion-item">
            <h3 class="accordion-header">
            <a class="accordion-button collapsed" href="#{{$category->expoindustry}}" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="{{$category->expoindustry}}">{{$category->expoindustry}}</a></h3>
            <div class="accordion-collapse collapse" id="{{$category->expoindustry}}" data-bs-parent="#shop-categories">
              <div class="accordion-body">
                <div class="widget widget-links widget-filter">
                  ...
                  <div class="simplebar-content" style="padding: 4px 16px 0px 0px;">
                    ...
                    <span class="widget-filter-item-text" id="{{$category->id}}"> </span>
                    <span class="fs-xs text-muted ms-3">{{$expo->count()}}</span>
                    </a>
                    </li>
