...
<main>
    ...
    <div class="container py-lg-5 my-lg-5 position-relative">
    <form wire:submit.prevent="add">
        ...
        <div class="pb-2"> 
            ...
            <small class=" fs-sm  me-2 text-center text-sm-start">They help others decide what to visit next. </small>
        ...
        @if(!is_null($rate))
            <div class="col-sm-2 col-md-12 pb-2 ">
            ...
            <div class=" col-sm-10 mb-3 pb-2">
                <label class="form-label fw-bold" for="unp-product-name">Express more, write a review <span class="text-muted">(optional)</span></label>
        ...
        <div class="handheld-toolbar bg-secondary">
         <button class="btn btn-primary d-block w-100 mt-5" type="submit">Submit</button>
        </div>
    </form>
    </div>
</main>