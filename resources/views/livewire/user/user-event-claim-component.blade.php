<main>
        ...
        @foreach ($monthwise as $franchise) 
            ...
            @php
                $user = Auth::user()->id;
                $checkSelected = DB::table('usages')->where('event_id', $franchise->id)->where('user_id', $user)->where('status', '1')->where('admstatus','1')->value('event_id');
            @endphp

            {{$checkSelected}}
          @if($checkSelected == $franchise->event_id)
            <div class="container  ">
                <div class="row text-center p-1 gx-0 mb-1  shadow-sm  border rounded border-1 bg-accent text-light">
                    <div class="col  pr-0">
                    ...
                    <div class="col-3  p-0">
                        ...
                        <!-- <a class="round-circle" href="{{route('event.details',['slug' => $franchise->slug])}}">
                            ...
                            <a href="#" class="btn btn-primary btn-sm"  wire:click.prevent="claimer({{$franchise->id}})">Claimed</a>
            ...
            <div class="container  ">
                <div class="row text-center p-1 gx-0 mb-1  shadow-sm  border rounded border-1">
                    ...
                    <div class="col-3  p-0">
                        ...
                        <!-- <a class="round-circle" href="{{route('event.details',['slug' => $franchise->slug])}}">
                            <i class="bi bi-chevron-double-right"></i></a>  -->
                            <a href="#" class="btn btn-primary btn-sm"  wire:click.prevent="claimer({{$franchise->id}})"> claim </a>
