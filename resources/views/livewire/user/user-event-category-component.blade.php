                    ...
                    <div class="container">
                        <div class="row text-center p-1 gx-0 mb-1  shadow-sm  border rounded border-1">
                            ...
                            @if(is_null($franchise->image))
                                <a class="card-img-top d-block overflow-hidden" href="#" wire:click.prevent="claimer({{$franchise->id}})">Add</a>
                            @else

                                <a class="card-img-top d-block overflow-hidden" href="#" wire:click.prevent="claimer({{$franchise->id}})">
