...
class UserEventDetailsComponent extends Component
{
    public $slug;
    public $category_id;
    public $webo;
    ...
    public function render()
    {
        ...
        return view('livewire.user.user-event-details-component',['EventCountRate'=>$EventCountRate,'hastag'=>$hastag,'participants'=>$participants,'speaker'=>$speaker,'sponsership'=>$sponsership,'pavillion'=>$pavillion,'category'=>$category,'catevent'=>$catevent,'pendingDetails'=>$pendingDetails,'evento' => $evento])->layout('layouts.admin');
    }
}
